...
// Methods
    ...
    public void flatten() {
        ...
        for(Expression child : _children) {
            ...
            if(child instanceof AdditiveExpression) {           // if the child is an additive expression
                for(Expression grandchild : ((AdditiveExpression) child).getChildren()) {
    ...
    /**
     * returns the user a list of the children of the AdditiveExpression
     * @return the children of the AdditiveExpression
     */
